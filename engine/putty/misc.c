...
/* The Symbian versions of the memory management functions are in a separate
   file. In general it would be cleaner to separate memory management from the
   rest of misc.c. -- Petteri */
